...
def setup(dp: Dispatcher):
    ...
    dp.register_message_handler(user_registration.get_second_name, state=UserRegistration.second_name)
    dp.register_message_handler(user_registration.get_phone_number, state=UserRegistration.number)
    dp.register_message_handler(user_registration.get_email, state=UserRegistration.email)
    dp.register_message_handler(user_registration.get_city, state=UserRegistration.city)
